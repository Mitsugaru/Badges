...
public abstract class CommandHandler implements CommandExecutor {
    ...
    */
   protected final Map<String, BadgeCommand> registeredCommands = new HashMap<String, BadgeCommand>();
   /**
    ...
    *           - Root plugin.
    */
   public CommandHandler(Badges plugin, String cmd) {
      this.plugin = plugin;
      this.cmd = cmd;
   }
    ...
    *           command.
    */
   public void registerCommand(String label, BadgeCommand command) {
